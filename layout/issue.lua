...
return function(lc)
  return {
    build = function (base, options)
      ...
      view:addChild(lc:build("text", {height="wrap", width="wrap", data = { value = "Gains: " }, padding = lc.padding(5) }))
      
      local gainsView = lc:build("linear", {height="wrap", width="fill", direction="v"})
